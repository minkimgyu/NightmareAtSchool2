...
#include "LizardManSoundService.h"
#include "AIController.h"
#include "BehaviorTree/BlackboardComponent.h"
#include "Components/AudioComponent.h"
#include "Sound/SoundCue.h"

ULizardManSoundService::ULizardManSoundService()
{
	NodeName = TEXT("Update Monster Sound");
	Interval = 0.2f; // 0.2초 체크
}

void ULizardManSoundService::TickNode(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory, float DeltaSeconds)
{
	...
	// 현재 state 체크
	bool bIsIlluminated = BBComp->GetValueAsBool(TEXT("IsIlluminated")); // 손전등에 맞았을때 추격상태
